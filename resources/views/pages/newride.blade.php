                        ...
                        <div>
                                ...
                                <div class="row mb-2" style="padding:20px 10px 15px 0px;">
                                    <div class="col-md-5">
                                        ...
                                        <select name="category" class="form-control"
                                            onchange="getVehicleByCategory(this)" id="category">
                            ...
                            <div class="container fullday-div d-none">
                                ...
                                <div class="row mb-2" style="padding: 15px;">
                                    ...
                                    <div class="col-md-3">
                                        <label for="">Trip Fare</label>
                                        <input type="text" class="form-control" name="trip_fare"
                                            placeholder="Trip Fare">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3" style="padding:0px 6px 5px 13px ;">
                                <a href="{{ url('rides') }}"><button type="button" data-dismiss="modal"
                                        aria-label="Close" class="btn btn-white"
